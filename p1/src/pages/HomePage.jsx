...
// --- Custom Hook to detect when an element is on screen within a specific scrollable container ---
      ...
      <div className="h-screen flex flex-col bg-green-50">
        ...
        <main ref={mainScrollRef} className="flex-1 overflow-y-auto">
          ...
          <section className="text-center h-[450px] flex items-center justify-center bg-gradient-to-br from-green-100 to-green-200 overflow-hidden">
            <div className="px-4">
              <h2 
                className="text-4xl md:text-5xl font-extrabold text-green-900 opacity-0"
                style={{ animation: `fadeInUp 1s ease-out 0.2s forwards`}}
              >
                Your Journey to Mental Wellness Starts Here
              </h2>
              <p 
                className="mt-4 text-lg text-green-800 max-w-2xl mx-auto opacity-0"
          ...
          >
            <h3 
              className="text-3xl font-bold text-center text-green-900 mb-12 opacity-0"
              style={featuresIsVisible ? { animation: `fadeInUp 1s ease-out forwards` } : {}}
            >
              Our Core Features
            </h3>
          ...
          >
            <h3 
              className="text-3xl font-bold text-center text-green-900 mb-12 opacity-0"
              style={profilesIsVisible ? { animation: `fadeInUp 1s ease-out 0.2s forwards` } : {}}
            >
          ...
          >
             <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div>
                <h3 
                  className="text-3xl font-bold text-green-900 mb-8 opacity-0"
                  style={vlogsIsVisible ? { animation: `fadeInUp 1s ease-out 0.2s forwards` } : {}}
                >
                  Student Vlogs & Blogs
                </h3>
