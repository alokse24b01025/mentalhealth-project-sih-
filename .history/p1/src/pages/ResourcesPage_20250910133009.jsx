...
// This is the themed card for displaying a single resource with a working iframe.
const ResourceCard = ({ resource }) => {
  ...
  const renderContent = () => {
    switch (type) {
      case 'video':
        // This iframe is correctly configured to display and play YouTube videos.
        return (
          <iframe 
      ...
      case 'audio':
        return (
          <div className="flex items-center justify-center h-48 bg-green-50 rounded-lg">
             <p className="text-gray-500">Audio player will appear here.</p>
          </div>
        );
      default:
        return null;
