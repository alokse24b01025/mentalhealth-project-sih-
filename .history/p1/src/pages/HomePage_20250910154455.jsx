  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        {/* Left Side: Form */}
        <div>
          <h3 className="text-3xl font-bold text-green-900">Bring Mitr to your Organization</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-gray-500">By submitting this form, you agree to receive emails from Mitr. You can opt-out at any time.</p>
          </form>
        </div>
        {/* Right Side: Image */}
