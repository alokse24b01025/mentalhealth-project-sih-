    ...
    <>
      ...
      <div className="h-screen flex flex-col bg-green-50">
        ...
        <main ref={mainScrollRef} className="flex-1 overflow-y-auto">
          ...
          {/* --- UPDATED: Section with combined animations --- */}
          <section 
            ref={featuresRef}
            className={`py-16 bg-white transition-opacity duration-700 ease-out ${featuresIsVisible ? 'opacity-100' : 'opacity-0'}`}
          >
            <h3 
              className={`text-3xl font-bold text-center text-green-900 mb-12 transition-all duration-700 ease-out ${featuresIsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
            >
              Our Core Features
            </h3>
          ...
          <section 
            ref={profilesRef}
            className={`py-16 px-4 bg-green-50 transition-opacity duration-700 ease-out ${profilesIsVisible ? 'opacity-100' : 'opacity-0'}`}
          >
            <h3 
              className={`text-3xl font-bold text-center text-green-900 mb-12 transition-all duration-700 ease-out ${profilesIsVisible ? 'opacity-100 translate-y-0 delay-200' : 'opacity-0 translate-y-10'}`}
            >
          ...
          <section 
            ref={vlogsRef}
            className={`py-16 px-4 bg-white transition-opacity duration-700 ease-out ${vlogsIsVisible ? 'opacity-100' : 'opacity-0'}`}
          >
             <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div>
                <h3 
                  className={`text-3xl font-bold text-green-900 mb-8 transition-all duration-700 ease-out ${vlogsIsVisible ? 'opacity-100 translate-y-0 delay-200' : 'opacity-0 translate-y-10'}`}
                >
                  Student Vlogs & Blogs
                </h3>
          ...
          <section 
            ref={contactRef}
            className={`py-16 px-8 bg-green-50 transition-opacity duration-700 ease-out ${contactIsVisible ? 'opacity-100' : 'opacity-0'}`}
          >
            <div 
              className={`max-w-6xl mx-auto transition-all duration-700 ease-out ${contactIsVisible ? 'opacity-100 translate-y-0 delay-200' : 'opacity-0 translate-y-10'}`}
            >
