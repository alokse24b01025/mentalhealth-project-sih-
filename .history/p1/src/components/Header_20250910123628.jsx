...
const Header = () => {
  ...
  const NavLinks = () => (
    <div className="py-2">
      <NavLink to="/resources" className={mobileLinkClass} onClick={() => setIsMenuOpen(false)}>Resources</NavLink>
      <NavLink to="/booking" className={mobileLinkClass} onClick={() => setIsMenuOpen(false)}>Booking</NavLink>
      <NavLink to="/chat" className={mobileLinkClass} onClick={() => setIsMenuOpen(false)}>Chat</NavLink>
      <NavLink to="/peer-support" className={mobileLinkClass} onClick={() => setIsMenuOpen(false)}>Peer Support</NavLink>
    </div>
  );

  const mobileLinkClass = "block py-2 px-4 text-lg text-gray-700 hover:bg-green-50 rounded-md";
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-x-4" ref={menuRef}>
            ...
            <div className="relative">
              ...
              {/* Dropdown Menu Panel */}
              {isMenuOpen && (
                <div className="absolute top-14 left-0 w-64 bg-white/95 backdrop-blur-lg border border-gray-200 rounded-lg shadow-xl py-1">
                  <NavLinks />
                </div>
              )}
            </div>
