...
// --- Sub-component 1: The Form for creating a new post ---
// This component's only job is to handle the input field and button.
const PostForm = ({ newPost, setNewPost, isPosting, handlePost }) => {
  return (
    <div className="mb-6">
      <textarea
        value={newPost}
...
// --- Sub-component 2: The List that displays all posts ---
// This component's job is to render the feed and handle scrolling.
const PostList = ({ posts }) => {
  return (
    <div className="flex-grow overflow-y-auto space-y-4 pr-2">
      {posts.map(post => (
        // Each post is a separate, clean card
...
// This is now much cleaner. It manages the state and assembles the other pieces.
const PeerSupport = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-white/70 backdrop-blur-lg border border-white/20 shadow-xl rounded-2xl p-6 min-h-0">
      ...
      {/* Section 2: Render the PostForm component */}
      <PostForm 
        newPost={newPost}
      ...
      {/* Section 3: Render the PostList component */}
