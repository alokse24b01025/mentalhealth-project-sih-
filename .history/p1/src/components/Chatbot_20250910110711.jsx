...
const Chatbot = () => {
  // Add an initial welcome message so the chat doesn't start empty
  ...
  return (
    <div className="flex-1 flex flex-col bg-white border border-gray-200 rounded-2xl shadow-lg p-4">
