...
const PostForm = ({ newPost, setNewPost, isPosting, handlePost }) => {
  return (
    // This div now has top margin and a border to separate it from the list above
...
const PeerSupport = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-white/70 backdrop-blur-lg border border-white/20 shadow-xl rounded-2xl p-6 min-h-0">
      ...
      {/* -- LAYOUT CHANGED -- */}
      {/* The PostList (chat feed) now comes first */}
      <PostList posts={posts} />

      {/* The PostForm (typing area) now comes last */}
      <PostForm
        newPost={newPost}
